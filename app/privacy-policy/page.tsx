  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-sm">
        <h1 className="text-3xl font-bold mb-6 text-green-800 dark:text-green-300">Privacy Policy for Mini Forest</h1>
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>
              <strong>Application</strong> refers to Mini Forest, the software program provided by the Company.
            </li>
            <li>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Types of Data Collected</h3>

          <h4 className="text-md font-bold mt-4 mb-2">Personal Data</h4>
          <p>
          ...
          <h4 className="text-md font-bold mt-4 mb-2">Usage Data</h4>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Use of Your Personal Data</h3>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Disclosure of Your Personal Data</h3>
          <h4 className="text-md font-bold mt-4 mb-2">Business Transactions</h4>
          <p>
          ...
          <h4 className="text-md font-bold mt-4 mb-2">Law enforcement</h4>
          <p>
          ...
          <h4 className="text-md font-bold mt-4 mb-2">Other legal requirements</h4>
          ...
          <h3 className="text-lg font-bold mt-6 mb-2">Security of Your Personal Data</h3>
          <p>
          ...
          <p className="text-sm text-muted-foreground mt-8">Generated using Free Privacy Policy Generator</p>
        </div>
      </div>
    </div>
  )
